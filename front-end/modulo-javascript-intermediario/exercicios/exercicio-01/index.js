...
function trocarPrimeiraCor (){
    let divCores = document.getElementsByClassName('primeira-cor')
    let primeiraCor = divCores[0]

    primeiraCor.style.backgroundColor = 'yellow'
}

function trocarSegundaCor () {
    let divCores = document.getElementsByClassName('segunda-cor')

    let segundaCor = divCores[0]
    segundaCor.style.backgroundColor = 'green'
}



//RESOLUÇÃO
//O que eu mudaria: colocaria as variaveis em escopo global. Na aula não é ensinado da forma que foi resolvido.
